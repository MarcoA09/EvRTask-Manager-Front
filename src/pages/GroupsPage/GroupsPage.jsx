     ...
     <div className="fixed inset-0 bg-opacity-50 flex items-center justify-center z-50">
       <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
         ...
         <input type='text' {...register("namegroup", { required: "El nombre es requerido" })} 
          ...
          />
          {errors.namegroup && <p className='text-red-500'>{errors.namegroup.message}</p>}
        ...
        <input type='text' list='users' id="integrants"{...register("integrants", { 
  
    validate: () => integrants.length > 0 || "No has ingresado ningun integrante"
  })}
          className='w-full bg-zinc-100 text-gray-900 px-4 py-2 rounded-md my-2'
          placeholder='Busca un colaborador, selecciona y añade'
              ...
              <option>No users found</option>
                  ...
                  <ul>
                    {integrants.map((integrant, index) => 
                      ...
                      </div> {integrants.length === 0 && <p className='text-red-500'>Selecciona a un integrante por favor</p>}
